class DBProvider {
    constructor() {
        ...
        db.run('CREATE TABLE IF NOT EXISTS comments (id INTEGER PRIMARY KEY AUTOINCREMENT, comment TEXT, user TEXT, origin TEXT, date TEXT, FOREIGN KEY(user) REFERENCES users(login))');
